...
const MainScreen = function () {
  ...
  const [burger, setBurger] = useState([
    ...
    { id: 3, title: 'Малыш', body: 'Котлета, маринованные огурцы, соус, сыр', price: '249р', img: b3 },
    ...
    { id: 7, title: 'Бургер Чила', body: 'Лук, салат, сыр, котлета, маринованные огурцы, помидор, соус 249 островов', price: '498р', img: b7 },
  ...
  return (
    <div className='main--container'>
      {/*<div className="shopping_cart">
        <button className="shopping_cart-button" ><img src={shop_cart} alt="" /></button>
      </div>
      ...
      <div className="side-panel">
          ...
          <p className="side-title-text">{products}</p>
      </div>
